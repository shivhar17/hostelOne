...
export const StaffDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<"New" | "In Progress" | "Resolved">(
    "New"
  );
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-white pb-24 relative">
      ...
      {/* Floating + button → New Announcement */}
      <button
        onClick={() => navigate("/staff/new-announcement")}
        className="fixed bottom-6 right-6 w-14 h-14 bg-blue-600 rounded-full flex items-center justify-center text-white shadow-lg shadow-blue-600/40 hover:scale-105 active:scale-95 transition-all"
      >
        <Plus size={28} />
      </button>
    </div>
